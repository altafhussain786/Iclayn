        ...
        <>
            ...
            >
                ...
                {({ handleChange, handleBlur, handleSubmit, values, errors, touched, setFieldValue }) => (
                    ...
                    <>
                        <ScreenHeader isLoading={values?.loader} onPressSave={handleSubmit} isShowSave={true} extraStyle={{ backgroundColor: '#F5F6F8' }} isGoBack={true} onPress={() => { navigation.goBack() }} isShowTitle={true} title="Create Transaction" />
