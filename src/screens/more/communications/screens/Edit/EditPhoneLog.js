...
const EditPhoneLog = ({ navigation, route }) => {
    ...
    console.log(toData, "TO DATA==d==>");


    const toItem = toData?.find(to => to.clientId === defaultData?.toId);

    const toName = toItem
        ? toItem.companyName
            ? toItem.companyName
            : `${toItem.firstName || ''} ${toItem.lastName || ''}`.trim()
        : '';

    console.log(toItem, "TO NAME===>");
        ...
        <>
                ...
                initialValues={
                    {
                        ...
                        from: fromData?.find(from => from.userId === defaultData?.fromId)?.userProfileDTO?.fullName || "",
                        fromObj: fromData?.find(from => from.userId === defaultData?.fromId) || {},
                        isOpenFrom: false,
                        ...
                        isTimeOpen: false,
                        //duration
                        recordedTime: defaultData?.timer || '',
            ...
            >
                ...
                {({ handleChange, handleBlur, handleSubmit, values, errors, touched, setFieldValue }) => (
                    ...
                    <>
                        <ScreenHeader isLoading={values?.loader} onPressSave={handleSubmit} isShowSave={true} extraStyle={{ backgroundColor: '#F5F6F8' }} isGoBack={true} onPress={() => { navigation.goBack() }} isShowTitle={true} title="Edit Phone logs" />
